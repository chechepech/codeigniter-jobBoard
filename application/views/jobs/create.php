 ...
 <?php endif; ?>
  ...
  <h2 class="text-center"><?php echo $this->lang->line('job_create_form_instruction_1');?></h2>
  <div class="row">
  ...
  <?php echo form_open('jobs/create','role="form" class="form"'); ?>
    ...
    <div class="row">
      <div class="form-group">
        <div class="col-md-3 col-xs-4">
          ...
          <?php for ( $i = 1; $i <= 31; $i++) : ?>
            <?php if (date('j', time()) == $i) : ?> 
              <option selected value="<?php echo $i ; ?>"><?php echo date('jS', mktime(0,0,0,0, $i, date('Y'))) ; ?></option>
            <?php else : ?>
    ...
    <span class="help-block"><?php echo $this->lang->line('job_sunset_date_help'); ?></span>
    <div class="form-group">
